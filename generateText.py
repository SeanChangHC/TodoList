...
def text(prefix):
    ...
    # # parser.add_argument('--model_config', default='D:\Sean\gpt2通用中文模型\config.json', type=str, required=False,
    # #                     help='模型参数')
    # parser.add_argument('--tokenizer_path', default='/mnt/d/Sean/GPT2-Chinese-old_gpt_2_chinese_before_2021_4_22/cache/vocab_small.txt', type=str, required=False, help='词表路径')
    # parser.add_argument('--model_path', default='/mnt/d/Sean/ptt_model/final_model', type=str, required=False, help='模型路径')
